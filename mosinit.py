'''
Current clamp demo using Allen Brain's model 472352327.
...
from neuron472352327 import Neuron472352327
...
def demo(iapp):
    ...
    h.celsius = 34.0
    cell = Neuron472352327(name='neuron')
    ...
    vbox.intercept(0)
    vbox.map('Allen Institute model 472352327; v includes junction potential', 10, 10, 600, 400)

    # procedure for doing and plotting each simulation
    def do_current_clamp_experiment(amp, color):   
        ic.amp = amp / 1000.
        
        h.finitialize(-87.4209747314)
        h.fcurrent()
